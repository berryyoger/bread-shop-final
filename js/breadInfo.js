...
const baguette = {
  ...
  cost: 3000,
  remain: 8,
  title: "Crackly Crust, Open Crumb",
...
const PAC = {
  ...
  cost: 4000,
  remain: 5,
  title: "Dark Chocolate, Crisp Layers",
...
const canele = {
  ...
  cost: 2000,
  remain: 10,
  title: "Burnished Shell, Custard Heart",
...
const cookie = {
  ...
  cost: 2800,
  remain: 24,
  title: "Chewy Center, Crisp Edge",
  meta: "Fresh-baked chocolate chip cookie with a soft, chewy center, crisp edges, and puddles of dark chocolate finished with a pinch of sea salt.",
  onPage:
...
const scone = {
  ...
  cost: 3200,
  remain: 16,
  title: "Buttery Crust, Tender Crumb",
  meta: "Golden-topped butter scone with a crisp edge and soft, fluffy center. Baked fresh daily; great with jam or clotted cream.",
  onPage:
...
const madeleine = {
  ...
  cost: 2400,
  remain: 18,
  title: "Shell-Shaped, Soft & Buttery",
  meta: "French madeleine with a light crisp edge and soft lemon-vanilla crumb. Baked fresh daily; perfect with tea.",
  onPage:
...
const donut = {
  ...
  cost: 2500,
  remain: 20,
  title: "Light, Fluffy, Glazed",
  meta: "Soft yeast-raised donut with a thin, shiny sugar glaze and light bite.",
  onPage:
